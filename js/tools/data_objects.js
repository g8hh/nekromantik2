...
var ACH_DATA = {
    ...
    15: {
        ...
        secret: false,
        hint: '',
        reward: '让你所有的砖块保持声望，并保持你最好的砖块这个牺牲提高了 ^0.2 牺牲。',
        showEffect: false,
        hasReward: true,
        divID: 'ach15',
        canUnlock: function() {
    ...
    44: {
        ...
        desc: '在此转生中解锁精炼厂之前，让你的僵尸尸体乘数超过 10,000.',
        secret: false,
        hint: '',
        reward: '',
        showEffect: false,
    ...
    55: {
        ...
        secret: false,
        hint: '',
        desc: '在没有任何星系升级的情况下转生（你的第一次转生不算数）.',
        reward: '',
        hasReward: false,
        showEffect: false,
        divID: 'ach55',
    ...
    62: {
        ...
        desc: '触发星系效应软上限，或在不触发的情况下完成所有六个研究项目.',
        secret: false,
        hint: '',
        reward: '',
        hasReward: false,
    ...
    71: {
        ...
        desc: '让你真正的时间精华效果是反时间精华效果的两倍以上，而它们都至少是 1,000 倍.',
        secret: false,
        hint: '',
        reward: '双倍真实时间精华效果.',
        hasReward: true,
    ...
    73: {
        ...
        desc: '在 10 秒内转生至少 100 个星系.',
        secret: false,
        hint: '',
        reward: '你的单位尸体乘数会根据提升的数量得到提升.',
        hasReward: true,
        showEffect: true,
        divID: 'ach73',
        canUnlock: function() {
